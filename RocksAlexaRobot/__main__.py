...
*ʜᴇʟʟᴏ !*
✪ ɪ ᴀᴍ ʟᴇᴠᴄᴀᴛ sᴜᴘᴇʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ ᴜsᴇғᴜʟʟ ғᴇᴀᴛᴜʀᴇ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀs ʙᴜᴅᴅʏ 
────────────────────────
× *ʟᴇᴠᴄᴀᴛ ɪs ᴀ ɴᴀᴍᴇ ᴏғ sᴜᴄᴄᴇss ᴀ ᴘᴏᴡᴇʀғᴜʟʟ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ*
× *ʙᴀsᴇᴅ ᴏɴ sǫʟ ᴀɴᴅ ᴍᴏɴɢᴏᴅʙ ᴅᴀᴛᴀʙsᴀᴇ*
────────────────────────
✪ ʜɪᴛ /help
────────────────────────
✪ [CHANNEL](t.me/gamingaddictch) - [SUPPORT](t.me/gamingaddicts)
────────────────────────
✪ ──『*ᴛʜᴀɴᴋs  ғᴏʀ  ᴜsɪɴɢ*』
"""
...
buttons = [
    [
        InlineKeyboardButton(
                            text=" ᴀᴅᴅ ʟᴇᴠᴄᴀᴛ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ",
                            url="t.me/levcatmanagerbot?startgroup=true"),
                    ],
                   [
                       InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="t.me/gamingaddicts"),
                       InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ", url="t.me/gamingaddictch"),
                     ],
                    [                  
                       InlineKeyboardButton(
                             text="ᴏᴡɴᴇʀ",
                             url=f"https://t.me/catcaturboy"),
                       InlineKeyboardButton(
                             text="ᴍᴜsɪᴄ ʙᴏᴛ",
                             url=f"https://t.me/levcatmusicbot"),
                        ],
                       [
                           InlineKeyboardButton(text="ᴅᴏɴᴀᴛᴇ", url="t.me/levcat1"
         ),
    ],
]

HELP_STRINGS = """
✪ ʜᴇʏ ᴛʜᴇʀᴇ, ɪ'ᴍ *ʟᴇᴠᴄᴀᴛ*!
...
────────────────────────
✪ ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀᴇᴘᴏʀᴛ ʙᴜɢs ᴏʀ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴏɴ ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ ᴛʜᴇɴ ғᴇᴇʟ ғʀᴇᴇ ᴛᴏ ʀᴇᴀᴄʜ ᴏᴜᴛ: ᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](http://t.me/catcaturboy)
...
DONATE_STRING = """ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](t.me/catcaturboy)"""
HELP_IMG= "https://telegra.ph/file/e907ab3b53b6c352f34a4.jpg"
GROUPSTART_IMG= "https://telegra.ph/file/e907ab3b53b6c352f34a4.jpg"

PM_IMG = ( "https://telegra.ph/file/e907ab3b53b6c352f34a4.jpg" )
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text=" ᴋɪɴɢ ", url=f"t.me/catcaturboy"),
                  InlineKeyboardButton(text=" sᴜᴘᴘᴏʀᴛ ", url=f"t.me/gamingaddictch"),
                  ]
                ]
            ),
        )
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ* © [ᴄᴀᴛ](t.me/catcaturboy) *ᴀɴᴅ* [ʜᴀʀsʜɪᴛ sʜᴀʀᴍᴀ](t.me/HarshitSharma361)\n*ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ {} ᴍᴏᴅᴜʟᴇs:*\n".format(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                "https://telegra.ph/file/e907ab3b53b6c352f34a4.jpg",
                caption="「 ʟᴇᴠᴄᴀᴛ 」 ɪs ᴀʟɪᴠᴇ !",
            )
        except Unauthorized:
            LOGGER.warning(
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Levcat is now alive and functioning")
